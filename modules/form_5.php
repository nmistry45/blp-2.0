...
<body>
    ...
    <div class="main">
        ...
        <div class="container">
            ...
            <?php $pid = $_GET['pid'];
            $result_form_5 = mysqli_query($conn, "SELECT patient_name, study_no from form1 where pid = $pid");
            ...
            ?>
                <form method="POST" id="signup-form" class="signup-form" onsubmit="return checkDate(this)" action="../assets/php/form-55.php?pid=<?php echo $pid; ?>" enctype="multipart/form-data">
                    <div class="form-group" style="margin-top: 20px">
                        ...
                        <label for="op_patient_name" class="form-label" style="margin-left: -20px; font-size: 20px; color:blue;"><u><b><?php echo $row_form_5['patient_name']; ?></b></u></label>
                        <label for="study_no" class="form-label" style="margin-left: 215px; font-size: 20px; color:blue;"><u><b>Study Number:</b></u></label>
                        <label for="op_study_no" class="form-label" style="margin-left: -100px; font-size: 20px; color:blue;"><u><b><?php echo $row_form_5['study_no']; ?></b></u></label>
                    </div>
                <?php } ?>
                <hr>
                <h3><span class="title_text">
                        <center><b>5. Fortnightly/Monthly follow up sheet during ENL<b></center>
                    </span></h3>
                <hr>
                ...
                <div class="form-row" style="padding-left: 39px ;margin-top: 9px;">
                    ...
                    <div class="form-group" style="padding-left: 70px;margin-top: 9px;">
                        ...
                        <input type="text" name="time_point" id="time_point" placeholder="" />no.of weeks since randomisation
                    </div>
                </div>
                ...
                <div class="fieldset-content">
                    ...
                    <div class="form-row" style="padding-left: 39px ;margin-top: 9px;">
                        <div class="form-group" style="padding-left: -100px ;margin-top: 9px;">
                            <label for="current_medication" class="form-label"><b>Current Medication (i.e. during past 1 week): </b></label>
                            <input type="text" name="current_medication" id="current_medication" placeholder="Current Medication" />
                        </div>
                        <div class="form-group" style="padding-left: 70px; margin-top: 9px;">
                            <label for="weight_5" class="form-label">Weight</label>
                            <input type="text" name="weight_5" id="weight_5" placeholder="" /> kg
                        </div>
                    </div>
                    ...
                    <div class="fieldset-content">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="time_since_flare_began" id="time_since_flare_began" placeholder="Number of Days / Number of Weeks" />
                        </div>

                        <label style="color:blue;"><u><b>Treatment Prescribed: (reminder,give second dose of albendazole if steroids taken>=24 weeks)</u></b></label>
