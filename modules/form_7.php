...
<body>
  ...
  <div class="main">
    <div class="container">
      ...
      <?php $pid = $_GET['pid'];
      $result_form_7 = mysqli_query($conn, "SELECT patient_name, study_no from form1 where pid = $pid");
      while ($row_form7 = mysqli_fetch_assoc($result_form_7)) {
      ?>
        <form method="POST" id="signup-form" class="signup-form" action="../assets/php/form-77.php?pid=<?php echo $pid; ?>" enctype="multipart/form-data">
          <div class="form-group" style="margin-top: 20px">
            ...
            <label for="op_patient_name" class="form-label" style="margin-left: -20px; font-size: 20px; color:blue;"><u><b><?php echo $row_form7['patient_name']; ?></b></u></label>
            <label for="study_no" class="form-label" style="margin-left: 215px; font-size: 20px; color:blue;"><u><b>Study Number:</b></u></label>
            <label for="op_study_no" class="form-label" style="margin-left: -100px; font-size: 20px; color:blue;"><u><b><?php echo $row_form7['study_no']; ?></b></u></label>
          </div>
        <?php } ?>
          ...
          <table style="padding-left: 34px ;margin-top: 9px;" id="tb6" class="tab orlist">
            <tbody>
              ...
              <tr style="padding: 2px;">
                <td><input type="date" name="date_form_7[]" class="valid" style="width: 185px;"></td>
                <td><input type="text" name="staff_name_7[]" class="valid"></td>
                <td><input type="textarea" name="comments_7[]" class="valid"></td>
