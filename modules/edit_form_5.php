...
<body>
        ...
        <div class="container">
            ...
            <form method="POST" id="signup-form" class="signup-form" onsubmit="return checkDate(this)" action="../assets/php/update_form_5.php?pid=<?php echo $id; ?>" enctype="multipart/form-data">
                <div class="form-group" style="margin-top: 20px">
                            ...
                            <label for="op_clinic_id" class="form-label" style="margin-left: -150px;"><?php echo $row_form_5_1['clinic_id']; ?></label>
                            <label for="study_no" class="form-label" style="margin-left: 175px;">Study Number:</label>
                            <label for="op_study_no" class="form-label" style="margin-left: -150px;"><?php echo $row_form_5_1['study_no']; ?></label>
                <?php } ?>
                </div>
 ...
 <!-- <form   method="POST" id="signup-form" class="signup-form" action="form-66.php">-->
                                    <div class="row">
                                            ...
                                            <?php } if($row_form5_checkBox['Peptic_Ulcer'] === 'yes'){?>  
                                                <label class="checkbox-inline"style="padding-left:4px;margin-top:9px">
                                            ...
                                            <?php }if($row_form5_checkBox['Striae'] === 'yes') { ?>
                                                <label class="checkbox-inline"style="padding-left:4px;margin-top:9px">
                                            ...
                                            <?php } if($row_form5_checkBox['Herpes_Zoster'] === 'yes') { ?>
                                                <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                                    ...
                                    <input type="checkbox"  name="adverse_predni[4]"  value="yes" style="padding-left:4px;margin-top:9px">Hyperglycaemia 
                                            ...
                                            <?php }if($row_form5_checkBox['Hypertension'] === 'yes') { ?>
                                                <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                                    ...
                                    <input type="checkbox" name="adverse_predni[5]"  value="yes" style="padding-left:4px;margin-top:9px">Hypertension
                                            ...
                                            <?php } if($row_form5_checkBox['Malaena'] === 'yes') { ?>
                                                <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                                    ...
                                    <input type="checkbox"  name="adverse_predni[8]"  value="yes" style="padding-left:4px;margin-top:9px">Truncal Obesity  
                                            ...
                                            <?php }if($row_form5_checkBox['Osteoporosis'] === 'yes') { ?>
                                                <label class="checkbox-inline"style="padding-left:4px;margin-top:9px">
                                    ...
                                    <input type="checkbox"  name="adverse_predni[9]"  value="yes" style="padding-left:4px;margin-top:9px">Osteoporosis
                                            ...
                                            <?php }if($row_form5_checkBox['Moon_Face'] === 'yes') { ?>
                                                <label class="checkbox-inline"style="padding-left:4px;margin-top:9px">
                                    ...
                                    <input type="checkbox"  name="adverse_predni[10]"  value="yes" style="padding-left:4px;margin-top:9px">Moon Face
                                            ...
                                            <?php } if($row_form5_checkBox['Psychosis'] === 'yes') { ?>
                                                <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                                ...
                                <input type="checkbox"  name="adverse_predni[12]"  value="yes" style="padding-left:4px;margin-top:9px">Gastrointestinal bleeding
                                            ...
                                            <?php }if($row_form5_checkBox['Haematemesis'] === 'yes') { ?>
                                                <label class="checkbox-inline"style="padding-left:4px;margin-top:9px">
                                    ...
                                    <input type="checkbox" name="adverse_predni[13]"  value="yes" style="padding-left:4px;margin-top:9px">Haematemesis
                                            ...
                                            <?php } if($row_form5_checkBox['Extensive_Ringworm'] === 'yes') { ?>
                                                <label class="checkbox-inline"style="padding-left:4px;margin-top:9px">
                                    ...
                                    <input type="checkbox"  name="adverse_predni[14]"  value="yes" style="padding-left:4px;margin-top:9px">&nbsp;&nbsp;&nbsp;&nbsp;Extensive Ringworm
                                            ...
                                            <?php }if($row_form5_checkBox['Acne'] === 'yes') { ?>
                                                <label class="checkbox-inline"style="padding-left:4px;margin-top:9px">
 ...
 <!--</form>-->
				...
				<!--<form>	-->				
                                <div class="row">
                                        ...
                                        <?php } if($row_form5_checkBox2['Vomiting'] === 'y'){?>  
                                            <label class="checkbox-inline"style="padding-left:4px;margin-top:9px">
                                        ...
                                        <?php }if($row_form5_checkBox2['Nausea'] === 'yes') { ?>
                                            <label class="checkbox-inline"style="padding-left:4px;margin-top:9px">
                                        ...
                                        <?php } if($row_form5_checkBox2['Abdominal_Pain'] === 'yes') { ?>
                                            <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
	                            ...
	                            <div class="row">
                                        ...
                                        <?php }if($row_form5_checkBox2['Ichthyosis'] === 'yes') { ?>
                                            <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                                        ...
                                        <?php } if($row_form5_checkBox2['Weight_loss'] === 'yes') { ?>
                                            <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                                        ...
                                        <?php } if($row_form5_checkBox2['Conjuctiva'] === 'yes') { ?>
                                            <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
	                            ...
	                            <div class="row">
                                        ...
                                        <?php }if($row_form5_checkBox2['Diarrhoea,Chronic'] === 'yes') { ?>
                                            <label class="checkbox-inline"style="padding-left:4px;margin-top:9px">
                                        ...
                                        <?php }if($row_form5_checkBox2['Chronic_Dysentery'] === 'yes') { ?>
                                            <label class="checkbox-inline"style="padding-left:4px;margin-top:9px">
                                        ...
                                        <?php } if($row_form5_checkBox2['Skin_Discolouration'] === 'yes') { ?>
                                            <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                        ...
                        <div class="form-group" style="padding-left:34px">
                            ...
                            <input type="range"style="border:1px solid;background-color: lightblue;" name="time_since_flare_began" id="time_since_flare_began" min="1" max="14"  value="<?php echo $row_form_5['time_since_flare_began']; ?>" onchange="show_value3(this.value)">
