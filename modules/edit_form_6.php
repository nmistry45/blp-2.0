                    ...
                    <fieldset>
                        ...
                        <div class="fieldset-content">
                            ...
                            <div class="form-row" style="padding-left: 45px ;margin-top: 9px;">
                                <div class="staff" style="padding-left: 90px">
                                    <div class="form-group">
                                        <label for="Weight" class="form-label">Weight</label>
                                        <input type="number" name="Weight" id="Weight" value="<?php echo $row_form_6['Weight']; ?>"" />kg
                                </div>
                            </div>

                            <div class=" staff" style="padding-left:240px">
                                        <div class="form-group">
                                            <label for="BMI" class="form-label">BMI</label>
                                            <input type="number" name="BMI" id="BMI" value="<?php echo $row_form_6['BMI']; ?>"" />
                                </div>
                            </div>
                        </div>
