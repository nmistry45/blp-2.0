...
//to retrieve patient name
while ($row_form_1_patient_name = mysqli_fetch_assoc($result_form_1_patient_name)) {
  $var = $row_form_1_patient_name['patient_name'];
}
?>
...
<body>
  ...
  <body>
    ...
    <div id="invoice1">
          ...
          <tbody>
            <tr>
              <th colspan="7" id="" style="vertical-align:middle; text-align:center;">
                <h4 style="display:inline-block;"><strong>1. Initial Assessment Sheet</strong></h4>
              </th>
      ...
      <div class="container">
        ...
        <table class="table table-bordered">
          <tbody>
            <tr>
              <th colspan="7" id="" style="vertical-align:middle; text-align:center;">
                <h4 style="display:inline-block;"><strong>2. Baseline Assessment</strong></h4>
              </th>
            ...
            <?php while ($row_form2_date = mysqli_fetch_assoc($result_form2_date)) { ?>
              ...
              <tr>
                ...
                <td colspan="6"><?php echo date("d-m-Y", strtotime($row_form2_date['date'])); ?></td>
              </tr>
            ...
            <tr>
              <?php while ($row_form2_checkBox2 = mysqli_fetch_assoc($result_form2_checkBox2)) { ?>
                ...
                <td colspan="2" style="text-align:left"><strong>Clofazimine:</strong><?php echo "  " . $row_form2_checkBox2['Clofazmine']; ?></td>
                <td colspan="3" style="text-align:left"><strong>Thalidomide:</strong><?php echo "  " . $row_form2_checkBox2['Thalidamide']; ?></td>
              <?php } ?>
            </tr>
            ...
            <?php while ($row_form2_dateStartedPredni_currentDosePredni_currentDoseClofa_currentDoseThal = mysqli_fetch_assoc($result_form2_dateStartedPredni_currentDosePredni_currentDoseClofa_currentDoseThal)) { ?>
              ...
              <tr>
                <th colspan="1" id="">Current Daily Dose of Clofazimine (mg/day)</th>
              ...
              <tr>
                <th colspan="1" id="">Current Daily Dose of Thalidomide (mg/day)</th>
            ...
            <?php while ($row_form2_obs_ran_drugDosePredni_drugDurPredni_drugDoseClofa_drugDurClofa = mysqli_fetch_assoc($result_form2_obs_ran_drugDosePredni_drugDurPredni_drugDoseClofa_drugDurClofa)) { ?>
              ...
              <tr>
                <th colspan="1" id="">Clofazimine Dosage</th>
      ...
      <div class="d-flex justify-content-center" data-html2canvas-ignore="true">
        <a href="edit_form_1.php?pid=<?php echo $id; ?>" target="_blank" class=""><button type="button" class="btn edit fa-2x btn-danger">Edit Form1 Details</button></a><br><br>
        <a href="edit_form_2.php?pid=<?php echo $id; ?>" target="_blank" style="padding-left:30px;" class=""><button type="button" class="btn edit fa-2x btn-danger ">Edit Form2 Details</button></a><br><br>
      </div>
        ...
        ?>
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                <th colspan="7" id="" style="vertical-align:middle; text-align:center;">
                  <h4 style="display:inline-block;"><strong>3. Pre-Randomisation 3 Monthly Routine Follow-Up Sheet</strong></h4>
                </th>
                </th>
              ...
              <tr>
                <th colspan="1" id="">Date</th>
                <td colspan="6"><?php echo date("d-m-Y", strtotime($row_form3['date'])); ?></td>
              </tr>
          ...
          <div class="d-flex justify-content-center" data-html2canvas-ignore="true">
            <a href="edit_form_3.php?pid=<?php echo $id; ?>&f3id=<?php echo $f3id; ?>" target="_blank" class="">
              <button type="button" class="btn edit fa-2x btn-danger">Edit Form3 Details</button>
            </a>
          </div>
          <br>
        <?php } ?>
        ...
        ?>
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                <th colspan="7" id="" style="vertical-align:middle; text-align:center;">
                  <h4 style="display:inline-block;"><strong>4. Post-Randomisation 3 Monthly Routine Follow-Up Sheet</strong></h4>
                </th>
              ...
              <tr>
                <th colspan="1" id="">Date</th>
                <td colspan="6"><?php echo date("d-m-Y", strtotime($row_form4['formDate'])); ?></td>
              </tr>
          ...
          <div class="d-flex justify-content-center" data-html2canvas-ignore="true">
            <a href="edit_form_4.php?pid=<?php echo $id; ?>&f4id=<?php echo $f4id; ?>" target="_blank" class="">
              <button type="button" class="btn edit fa-2x btn-danger">Edit Form4 Details</button>
            </a>
          </div>
          <br>
        <?php } ?>
        ...
        ?>
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                <th colspan="7" id="" style="vertical-align:middle; text-align:center;">
                  <h4 style="display:inline-block;"><strong>5. Clinical Record Sheet</strong></h4>
                </th>
              ...
              <tr>
                <th colspan="1" id="">Date</th>
                <td colspan="6"><?php echo date("d-m-Y", strtotime($row_form5['date'])); ?></td>
              </tr>
          ...
          <div class="d-flex justify-content-center" data-html2canvas-ignore="true">
            <a href="edit_form_5.php?pid=<?php echo $id; ?>&f5id=<?php echo $f5id; ?>" target="_blank" class="">
              <button type="button" class="btn edit fa-2x btn-danger">Edit Form5 Details</button>
            </a>
          </div>
          <br>
        <?php } ?>
        ...
        ?>
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                <th colspan="7" id="" style="vertical-align:middle; text-align:center;">
                  <h4 style="display:inline-block;"><strong>6. Final Follow-Up Sheet at End of 24 months from Randomization (or at Withdrawal)</strong></h4>
                </th>
              ...
              <tr>
                <th colspan="1" id="">Date</th>
                <td colspan="6"><?php echo date("d-m-Y", strtotime($row_form6['date'])); ?></td>
              </tr>
          ...
          <div class="d-flex justify-content-center" data-html2canvas-ignore="true">
            <a href="edit_form_6.php?pid=<?php echo $id; ?>&f6id=<?php echo $f6id; ?>" target="_blank" class="">
              <button type="button" class="btn edit fa-2x btn-danger">Edit Form6 Details</button>
            </a>
          </div>
          <br>
        <?php } ?>
        ...
        <?php if (mysqli_num_rows($form_7) > 0) { ?>
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                <th colspan="7" id="" style="vertical-align:middle; text-align:center;">
                  <h4 style="display:inline-block;"><strong>7. Miscellaneous Notes by Research Staff</strong></h4>
                </th>
          ...
          <div class="d-flex justify-content-center" data-html2canvas-ignore="true">
            <a href="edit_form_7.php?pid=<?php echo $id; ?>&misid=<?php echo $misid; ?>" target="_blank" class="">
              <button type="button" class="btn edit fa-2x btn-danger ">Edit Form7 Details</button>
            </a>
          </div>
          <br>
        <?php } ?>
        ...
        ?>
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                <th colspan="7" id="" style="vertical-align:middle; text-align:center;">
                  <h4 style="display:inline-block;"><strong>8. Checklist for Adverse Effects</strong></h4>
                </th>
          ...
          <div class="d-flex justify-content-center" data-html2canvas-ignore="true">
            <a href="edit_form_8.php?pid=<?php echo $id; ?>&f8id=<?php echo $f8id; ?>" target="_blank" class="">
              <button data-exclude="true" type="button" class="btn edit fa-2x  btn-danger ">Edit Form8 Details</button>
            </a>
          </div>
    ...
    <div class="btn btn-light-blue" style="display: flex; justify-content: space-around; padding-left:145px;">
      <button type="button" name="new_patient" id="new_patient" class="btn add btn-warning btn-lg" onclick="location.href='form_1.php';" style="margin-right:auto;">
        Add New Patient&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </button>
      <button type="button" id="download" onclick="makePdf();" class="btn pdf btn-warning btn-lg" style="margin-right: 85px;">Generate PDF of Patient &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
    </div>
