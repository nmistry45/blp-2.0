    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="container">
                ...
                <?php
                $result_form_3_1 = mysqli_query($conn, "SELECT patient_name, study_no from form1 where pid = $id");
                ...
                ?>
                    <form method="POST" id="signup-form" class="signup-form" onsubmit="return formThreeJavascript(this)" action="../assets/php/update_form_3.php?pid=<?php echo $id; ?>&f3id=<?php echo $f3id ?>" enctype="multipart/form-data">
                        <div class="form-group" style="margin-top: 20px">
                            ...
                            <label for="op_patient_name" class="form-label" style="margin-left: -20px; font-size: 20px; color:blue;"><u><b><?php echo $row_form_3_1['patient_name']; ?></b></u></label>
                            <label for="study_no" class="form-label" style="margin-left: 215px; font-size: 20px; color:blue;"><u><b>Study Number:</b></u></label>
                            <label for="op_study_no" class="form-label" style="margin-left: -100px; font-size: 20px; color:blue;"><u><b><?php echo $row_form_3_1['study_no']; ?></b></u></label>
                        </div>
                    <?php } ?>
                    ...
                    <div class="form-row" style="padding-left: 76px ;margin-top: 9px;">
                        <div class="form-group" style="padding-left: 48px ;margin-top: 9px;">
                        ...
                        <div class="form-group" style="padding-left:40px;">
                            ...
                            <input style="width: 150px;" type="text" name="time_point" id="time_point" placeholder="Time Point" value="<?php echo $row_form_3['time_point']; ?>" /><label>(number of weeks since enrolment)</label>
                        </div>
                    </div>

                    <div class="form-group" style="padding-left:40px;">
                        <label for="staff_name" class="form-label">Staff Name</label>
                        <input style="width: 205px;" type="text" name="staff_name" id="staff_name" placeholder="Staff Name" value="<?php echo $row_form_3['staff_name']; ?>" />
                    </div>
                    ...
                    <div class="form-radio" style="padding-left:34px;">
                        ...
                        <div class="form-radio-item">
                            ...
                            <?php }
                            if ($row_form_3['current_reaction_status'] === 'RR') { ?>
                            ...
                            <?php }
                            if ($row_form_3['current_reaction_status'] === 'acute enl') { ?>
                            ...
                            <?php }
                            if ($row_form_3['current_reaction_status'] === 'recurrent enl') { ?>
                            ...
                            <?php }
                            if ($row_form_3['current_reaction_status'] === 'chronic enl') { ?>
                        ...
                        <div class="form-group" style="padding-right:-100px;">
                            ...
                            <input type="text" name="weight" id="weight" placeholder="" value="<?php echo $row_form_3['weight']; ?>" /> kg
                        </div>
                    </div>
                    ...
                    <div class="fieldset-content">
                        ...
                        <div class="form-row" style="padding-left:34px;">
                            <div class="form-group" style="padding-left:34px;">&ensp;&ensp;
                                ...
                                <input style="margin-left: 10px;" type="text" name="rand_date" id="rand_date" value="<?php echo $row_form_3['rand_date']; ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <label for="assessment_date" class="form-label" style="padding-left:20px;">Date of Next<br> Assessment </label>
                                <input style="margin-left: 14px; width:180px;" type="date" name="assessment_date" id="assessment_date" value="<?php echo $row_form_3['assessment_date']; ?>" />
                            </div>
                        </div>
