...
$id = $_GET['pid'];
$f4id = $_GET['f4id'];
$result_form_4 = mysqli_query($conn, "SELECT * from form4 where pid = $id and f4id = $f4id");

while ($row_form_4 = mysqli_fetch_assoc($result_form_4)) {
    $result_form4_checkBox2 = mysqli_query($conn, "SELECT * from form4_checkbox2 where f4id = $f4id");
    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="container">
                ...
                <?php
                $result_form_4_1 = mysqli_query($conn, "SELECT patient_name, study_no from form1 where pid = $id");
                ...
                ?>
                    <form method="POST" id="signup-form" class="signup-form" action="../assets/php/update_form_4.php?pid=<?php echo $id; ?>&f4id=<?php echo $f4id ?>" enctype="multipart/form-data">
                        <div class="form-group" style="margin-top: 20px">
                            ...
                            <label for="op_patient_name" class="form-label" style="margin-left: -20px; font-size: 20px; color:blue;"><u><b><?php echo $row_form_4_1['patient_name']; ?></b></u></label>
                            <label for="study_no" class="form-label" style="margin-left: 215px; font-size: 20px; color:blue;"><u><b>Study Number:</b></u></label>
                            <label for="op_study_no" class="form-label" style="margin-left: -100px; font-size: 20px; color:blue;"><u><b><?php echo $row_form_4_1['study_no']; ?></b></u></label>
                        </div>
                    <?php } ?>
                    <hr>
                    <h3>
                    ...
                    <div class="form-row" style="padding-left: 34px ;margin-top: 9px;">
                        ...
                        <div class="form-group" style="padding-left:20px">
                            ...
                            <input type="text" name="time_point" id="time_point" placeholder="" value="<?php echo $row_form_4['time_point']; ?>" />
                            <label for="time_point" class="form-label">(number if week since randomisation)</label>
                        </div>

                        <div class="form-group" style="padding-left: 47px ;margin-top: 9px;">
                    ...
                    <div class="form-radio" style="padding-left:34px">
                        ...
                        <div class="form-radio-item">
                            ...
                            <?php }
                            if ($row_form_4['current_status'] === 'RR') { ?>
                            ...
                            <?php }
                            if ($row_form_4['current_status'] === 'acute enl') { ?>
                            ...
                            <?php }
                            if ($row_form_4['current_status'] === 'recurrent enl') { ?>
                            ...
                            <?php }
                            if ($row_form_4['current_status'] === 'chronic enl') { ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="weight" id="weight" placeholder="in kg" value="<?php echo $row_form_4['weight']; ?>" />kg
                    ...
                    <div class="fieldset-content">
                        ...
                        <div class="form-radio" style="padding-left:34px;">
                            ...
                            <div class="form-radio-item">
                                <?php if ($row_form_4['new_nfi_4'] === 'yes') { ?>
                                    <input type="radio" name="new_nfi_4" value="yes" id="nfiyes" checked />
                                ...
                                <?php }
                                if ($row_form_4['new_nfi_4'] === 'no') { ?>
                                    <input type="radio" name="new_nfi_4" value="no" id="nfino" checked />
                            ...
                            <div style="padding-left:30px;">
                                <textarea rows="4" cols="50" name="Add1" id="Add1" placeholder="Within Past 6 months, Not Yet Treated with Steroids?"><?php echo $row_form_4['Add1']; ?></textarea>
                            </div>
                        </div>
                            ...
                            <div class="container" style="margin-top: 9px">
                                ...
                                <div class="row">
                                    <?php while ($row_form4_checkBox = mysqli_fetch_assoc($result_form4_checkBox)) { ?>
                                        ...
                                        <?php }
                                        if ($row_form4_checkBox['Peptic_Ulcer'] === 'yes') { ?>
                                            <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                                        ...
                                        <?php }
                                        if ($row_form4_checkBox['Striae'] === 'yes') { ?>
                                            <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                                        ...
                                        <?php }
                                        if ($row_form4_checkBox['Herpes_Zoster'] === 'yes') { ?>
                                            <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                                ...
                                <div class="row">
                                    ...
                                    <?php }
                                        if ($row_form4_checkBox['Hypertension'] === 'yes') { ?>
                                        <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                                    ...
                                    <?php }
                                        if ($row_form4_checkBox['Malaena'] === 'yes') { ?>
                                        <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                                    ...
                                    <?php }
                                        if ($row_form4_checkBox['Glaucoma'] === 'yes') { ?>
                                        <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                                ...
                                <div class="row">
                                    ...
                                    <?php }
                                        if ($row_form4_checkBox['Osteoporosis'] === 'yes') { ?>
                                        <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                                    ...
                                    <?php }
                                        if ($row_form4_checkBox['Moon_Face'] === 'yes') { ?>
                                        <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                                    ...
                                    <?php }
                                        if ($row_form4_checkBox['Psychosis'] === 'yes') { ?>
                                        <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                                ...
                                <div class="row">
                                    ...
                                    <?php }
                                        if ($row_form4_checkBox['Haematemesis'] === 'yes') { ?>
                                        <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                                    ...
                                    <?php }
                                        if ($row_form4_checkBox['Extensive_Ringworm'] === 'yes') { ?>
                                        <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                                    ...
                                    <?php }
                                        if ($row_form4_checkBox['Acne'] === 'yes') { ?>
                                        <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                            ...
                            <div class="container" style="margin-top: 9px">
                                ...
                                <div class="row">
                                    <?php while ($row_form4_checkBox2 = mysqli_fetch_assoc($result_form4_checkBox2)) { ?>
                                        ...
                                        <?php }
                                        if ($row_form4_checkBox2['Vomiting'] === 'yes') { ?>
                                            <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                                        ...
                                        <?php }
                                        if ($row_form4_checkBox2['Nausea'] === 'yes') { ?>
                                            <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                                        ...
                                        <?php }
                                        if ($row_form4_checkBox2['Abdominal_Pain'] === 'yes') { ?>
                                            <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                                ...
                                <div class="row">
                                    ...
                                    <?php }
                                        if ($row_form4_checkBox2['Ichthyosis'] === 'yes') { ?>
                                        <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                                    ...
                                    <?php }
                                        if ($row_form4_checkBox2['Weight_loss'] === 'yes') { ?>
                                        <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                                    ...
                                    <?php }
                                        if ($row_form4_checkBox2['Conjuctiva'] === 'yes') { ?>
                                ...
                                <div class="row">
                                    ...
                                    <?php }
                                        if ($row_form4_checkBox2['Diarrhoea,Chronic'] === 'yes') { ?>
                                        <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                                    ...
                                    <?php }
                                        if ($row_form4_checkBox2['Chronic_Dysentery'] === 'yes') { ?>
                                        <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                                    ...
                                    <?php }
                                        if ($row_form4_checkBox2['Skin_Discolouration'] === 'yes') { ?>
                                        <label class="checkbox-inline" style="padding-left:4px;margin-top:9px">
                        ...
                        <div class="form-radio" style="padding-left:34px">
                            ...
                            <div class="form-radio-item">
                                ...
                                <?php }
                                if ($row_form_4['advised_admission'] === 'no') { ?>
