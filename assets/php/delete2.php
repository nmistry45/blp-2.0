...
$result = mysqli_query($conn, "DELETE from form1_checkbox where pid='$id'");
...
$result = mysqli_query($conn, "DELETE from form7 where pid='$id'");
$result = mysqli_query($conn, "DELETE from form8_checkbox where pid='$id'");
$result = mysqli_query($conn, "DELETE from form8_checkbox2 where pid='$id'");
