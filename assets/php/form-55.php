...
include('connection.php');
	...
	function query ( $query, $message = '' ) {
		...
		$query1 = "INSERT INTO form5_checkbox VALUES ('$f5id','$pid', '$check_0d','$check_1d','$check_2d', '$check_3d','$check_4d','$check_5d', '$check_6d','$check_7d','$check_8d', '$check_9d','$check_10d','$check_11d', '$check_12d','$check_13d','$check_14d','$check_15d')";
