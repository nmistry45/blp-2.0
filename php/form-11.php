 <?php
	...
	function query ( $query, $message = '' ) {
		...
		$q = "insert into form1 (patient_name,clinic_id,study_no,date,staff_name,patient_name1,sex,clinic_regno,address,dateMDT,
		dateRFT,SmearDiagnosis,SmearDate,mdiag,Age,Weight,Height,BMI,no_contra_indication_steroids,able_to_attend_regularly,
		pregnant,tuberculosis,diabetes,other_serious_illness,other_illness_desc,inform_consent,allocate_study_no,history_of_enl) 
		values ('$patient_name','$clinic_id','$study_no','$date','$staff_name','$patient_name1','$sex','$clinic_regno','$address','$dateMDT','$dateRFT',
		'$SmearDiagnosis','$SmearDate','$mdiag','$Age','$Weight','$Height','$BMI','$no_contra_indication_steroids','$able_to_attend_regularly',
		'$pregnant','$tuberculosis','$diabetes','$other_serious_illness','$other_illness_desc','$inform_consent','$allocate_study_no','$history_of_enl');";
		// echo $q;
